...
const PATHS: Record<IconName, string> = {
  ...
  speaking: 'M12 15a3 3 0 0 0 3-3V6a3 3 0 0 0-6 0v6a3 3 0 0 0 3 3ZM5 11a7 7 0 0 0 14 0M12 18v3',
  writing: 'M4 20h16M6 16l9-9 3 3-9 9H6v-3Z',
  reading: 'M12 6c-2-1.5-5-1.5-8 0v12c3-1.5 6-1.5 8 0 2-1.5 5-1.5 8 0V6c-3-1.5-6-1.5-8 0Zm0 0v12',
  listening: 'M4 13v-1a8 8 0 0 1 16 0v1M4 13a2 2 0 0 0 2 2h1v-5H6a2 2 0 0 0-2 2Zm16 0a2 2 0 0 1-2 2h-1v-5h1a2 2 0 0 1 2 2Z',
  back: 'M15 5l-7 7 7 7',
  ...
  rocket: 'M5 15c-1 2-1 4-1 4s2 0 4-1M9 15l-3-3 4-6c2-3 5-4 8-4 0 3-1 6-4 8l-6 4-3-3Z',
  export: 'M12 15V4M8 8l4-4 4 4M5 15v4h14v-4',
  info: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 11v5M12 8h.01',
  translate: 'M3 5h9M7 4v1M9 5c0 5-4 8-6 8M5 9c0 2 3 4 6 4M14 20l4-9 4 9M15.5 17h5',
